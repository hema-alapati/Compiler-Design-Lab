...
{
    if (!strcmp(str, "template") || !strcmp(str, "explicit") || !strcmp(str, "volatile") || !strcmp(str, "export") || !strcmp(str, "class") || !strcmp(str, "catch") || !strcmp(str, "not") || !strcmp(str, "friend") || !strcmp(str, "namespace") || !strcmp(str, "default") || !strcmp(str, "goto") || !strcmp(str, "signed") || !strcmp(str, "this") || !strcmp(str, "throw") || !strcmp(str, "using") || !strcmp(str, "xor") || !strcmp(str, "try") || !strcmp(str, "true") || !strcmp(str, "false") || !strcmp(str, "if") || !strcmp(str, "else") ||
        !strcmp(str, "while") || !strcmp(str, "do") ||
        !strcmp(str, "break") || !strcmp(str, "continue") || !strcmp(str, "int") || !strcmp(str, "double") || !strcmp(str, "float") || !strcmp(str, "return") || !strcmp(str, "char") || !strcmp(str, "case") || !strcmp(str, "long") || !strcmp(str, "short") || !strcmp(str, "typedef") || !strcmp(str, "switch") || !strcmp(str, "unsigned") || !strcmp(str, "void") || !strcmp(str, "static") || !strcmp(str, "struct") || !strcmp(str, "sizeof") || !strcmp(str, "long") || !strcmp(str, "volatile") || !strcmp(str, "typedef") || !strcmp(str, "enum") || !strcmp(str, "const") || !strcmp(str, "union") || !strcmp(str, "extern") || !strcmp(str, "bool") || !strcmp(str, "and") || !strcmp(str, "auto"))
    {
        return true;
    }
    else
